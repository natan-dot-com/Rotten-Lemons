...
CREATE TABLE COMENTARIO_REMOVIDO (
    ...
    CONSTRAINT FK2_COMENTARIOREMOVIDO FOREIGN KEY (AUTOR_REMOCAO) REFERENCES
        USUARIO (NOME_USUARIO) ON DELETE CASCADE
);
...
CREATE TABLE TAG_REMOVIDA (
    ...
    CONSTRAINT PK_TAGREMOVIDA PRIMARY KEY (TAG, MUSICA, AUTOR_REMOCAO),
    CONSTRAINT FK1_TAGREMOVIDA FOREIGN KEY (TAG) REFERENCES
        TAG (NOME_TAG) ON DELETE CASCADE,
    CONSTRAINT FK2_TAGREMOVIDA FOREIGN KEY (AUTOR_REMOCAO) 
